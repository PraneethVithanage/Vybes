...
extension URLRequest {
    ...
    static public func getProducts() -> URLRequest {
        let BaseUrl = "https://59b8726e92ccc3eb44b0c193eeef96f6.m.pipedream.net"
        var component: URLComponents?
        component = URLComponents(string: BaseUrl + "/products")
